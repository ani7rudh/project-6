...
<!-- 	        						<li class="active-slide"><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}.jpg" ><img src="resources/images/{{productdata.productId}}.jpg" alt="Phone photo 1"></a></li> -->
<!-- 	        						<li><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}.jpg"><img src="resources/images/{{productdata.productId}}.jpg" alt="Phone photo 2"></a></li> -->
<!-- 	        						<li><a data-rel='prettyPhoto' href="resources/mypro/images/products/big-phone3.jpg"><img src="resources/mypro/images/thumbnails/phone3.jpg" alt="Phone photo 3"></a></li> -->
<!-- 	        						<li><a data-rel='prettyPhoto' href="resources/mypro/images/products/big-phone4.jpg"><img src="resources/mypro/images/thumbnails/phone4.jpg" alt="Phone photo 4"></a></li> -->
<!-- 	        						<li><a data-rel='prettyPhoto' href="resources/mypro/images/products/big-phone5.jpg"><img src="resources/mypro/images/thumbnails/phone5.jpg" alt="Phone photo 4"></a></li> -->

        					</ul><!-- End product-carousel -->
        					</div>

        					<div id="product-image-container">
        						<figure><img src="resources/images/{{productdata.productId}}.jpg" alt="Product Big image" id="product-image" data-big="resources/images/{{productdata.productId}}.jpg">
    ...
    <h2>product details</h2>
       ...
       product quantity: {{productdata.productQuantity}}<br>
        ...
        product category:{{productdata.categoryName}}<br>
                       ...
                       <div class="product-size-filter-container">
                        ...
                        <hr>
							...
							<div class="product-add clearfix">
								...
								<a class="btn btn-custom-2" >ADD TO CART</a>
        								...
        								<ul class="related-list clearfix">
        									<li>
        										<div class="related-product clearfix">
        											<figure>
        												<img src="resources/mypro/images/thumbnails/item1.jpg" alt="item1">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="resources/mypro/images/thumbnails/item2.jpg" alt="item2">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="resources/mypro/images/thumbnails/item3.jpg" alt="item3">
        											</figure>
        									...
        									<li>
        										<div class="related-product clearfix">
        											<figure>
        												<img src="resources/mypro/images/thumbnails/item4.jpg" alt="item4">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="resources/mypro/images/thumbnails/item5.jpg" alt="item5">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="resources/mypro/images/thumbnails/item6.jpg" alt="item6">
        											</figure>
        				...
        				<div class="purchased-items-container carousel-wrapper">
                            <header class="content-title">
                                ...
                                <div class="purchased-items-slider owl-carousel">
                                            ...
                                            <figure>
                                                <a href="product.html">
                                                    <img src="resources/mypro/images/phone5.jpg" alt="item3" class="item-image">
                                                    <img src="resources/mypro/images/phone5-hover.jpg" alt="item3 Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                                <div class="item-price-container">
                                        ...
                                        <div class="item">
                                            ...
                                            <figure>
                                                <a href="product.html">
                                                    <img src="resources/mypro/images/item4.jpg" alt="item3" class="item-image">
                                                    <img src="resources/mypro/images/item4-hover.jpg" alt="item3 Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                                <div class="item-price-container">
                                        ...
                                        <div class="item">
                                            ...
                                            <figure>
                                                <a href="product.html">
                                                    <img src="resources/mypro/images/item2.jpg" alt="item3" class="item-image">
                                                    <img src="resources/mypro/images/item2-hover.jpg" alt="item3 Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                                <div class="item-price-container">
                                                    <span class="item-price">$89<span class="sub-price">.75</span></span>
                                                </div>
                                                <span class="new-rect">New</span>
                                            </div><!-- End .item-image -->
                                            <div class="item-meta-container">
